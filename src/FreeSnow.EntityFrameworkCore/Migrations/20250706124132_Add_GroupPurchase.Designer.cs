...
{
    [DbContext(typeof(FreeSnowDbContext))]
    [Migration("20250706124132_Add_GroupPurchase")]
    partial class Add_GroupPurchase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeSnow.Entities.GroupPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GroupPurchase");
                });

            modelBuilder.Entity("FreeSnow.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GroupPurchasePost", b =>
                {
                    b.Property<Guid>("GroupPurchasesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("PostsId")
                        .HasColumnType("uuid");

                    b.HasKey("GroupPurchasesId", "PostsId");

                    b.HasIndex("PostsId");

                    b.ToTable("GroupPurchasePost");
                });
            ...
            modelBuilder.Entity("GroupPurchasePost", b =>
                {
                    b.HasOne("FreeSnow.Entities.GroupPurchase", null)
                        .WithMany()
                        .HasForeignKey("GroupPurchasesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FreeSnow.Entities.Post", null)
                        .WithMany()
